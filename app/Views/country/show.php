<?php
/** Fiche pays — variables : $prefixRacine, $erreur, $pays, $lieux, $pageTitre */
$pays  = $pays ?? null;
$lieux = $lieux ?? [];
?>
    <div class="conteneur conteneur-pays">
        <?php if ($erreur !== null) : ?>
            ...
            <p><a class="btn" href="<?= e($prefixRacine) ?>index.php">Accueil</a></p>
        <?php else : ?>
            ...
            <?php else : ?>
                <div class="grille-lieux-pays">
                    <?php foreach ($lieux as $L) :
                        ...
                        $nb  = (int) ($L['nb_avis'] ?? 0);
                        ?>
                    <a class="carte-lieu-pays" href="place.php?id=<?= $idL ?>">
