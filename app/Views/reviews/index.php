<?php
/** Liste paginée des avis — variables : $liste, $page, $pagesTotal, $totalAvis, $parPage, $filtreNote, $filtrePays, $paysListe */
$liste       = $liste ?? [];
$page        = $page ?? 1;
...
?>
    <div class="conteneur conteneur-avis-liste">
        ...
        <form class="form-filtres-avis" method="get" action="reviews.php" aria-label="Filtrer la liste">
            <div class="filtres-row">
                ...
                <a class="lien-reset-filtres" href="reviews.php">Réinitialiser</a>
            </div>
        </form>
        ...
        <?php else : ?>
            ...
            <nav class="pagination-avis" aria-label="Pagination">
                <?php if ($page > 1) : ?>
                    <a class="page-nav" href="reviews.php?<?= e(reviews_pagination_query($qBase, $page - 1)) ?>">Précédent</a>
                <?php else : ?>
                ...
                <?php if ($page < $pagesTotal) : ?>
                    <a class="page-nav" href="reviews.php?<?= e(reviews_pagination_query($qBase, $page + 1)) ?>">Suivant</a>
                <?php else : ?>
