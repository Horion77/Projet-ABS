...
<div class="conteneur conteneur-auth">
    ...
    <form id="form-inscription" class="form-auth" method="post" action="/inscription" novalidate>
    ...
    <p class="lien-auth-bas">Déjà inscrit ? <a href="/connexion">Se connecter</a></p>
</div>
